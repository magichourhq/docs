...
## Add tested generation workflows

The MCP gives your assistant access to Magic Hour tools. The [Magic Hour skills
cookbook](https://github.com/magichourhq/skills) adds validated workflows for stronger prompts,
tool sequencing, output review, and recovery without duplicate paid jobs.

```bash
npx skills add magichourhq/skills --all
```

The focused product-visual and image-to-video skills include the quality comparisons behind their
guidance. You can also install one skill from the [cookbook](https://github.com/magichourhq/skills#cookbook).
