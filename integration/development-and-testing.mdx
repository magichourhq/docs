...
- Compare the job age with the [observed processing time for its endpoint](/api-reference/processing-times). Some video workflows normally take longer than five minutes
