...
reference](/webhook-reference/video-events/video-completed) for its complete schema.
...
- Log event IDs, types, and outcomes without logging secrets or raw payloads
