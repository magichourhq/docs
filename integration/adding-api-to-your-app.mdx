...
<Steps>
  ...
  <Step title="Cancel render">Select the cancellation action in project details.</Step>
  <Step title="Confirm cancellation">Confirm the cancellation in the dialog.</Step>
  <Step title="Cancellation complete">Wait for the cancellation confirmation.</Step>
</Steps>
