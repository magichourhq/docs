...
1. Visit [Developer Hub](https://magichour.ai/developer?tab=api-keys) to create an API key.
...
1. configure a webhook in [Developer Hub](https://magichour.ai/developer?tab=webhooks), and pick the events you want to be notified.
