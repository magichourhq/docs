...
<Note>
  **Estimated time**: 15-20 minutes **Prerequisites**: API key from [Developer
  ...
  Python 3.10+ or Node.js 22+ installed
</Note>
...
Enable ES modules without replacing the SDK version installed in Step 2:
...
- Handles different statuses: queued, rendering, complete, error, canceled
