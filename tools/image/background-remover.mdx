...
description: Detect the main subject and return a PNG with transparency.
---
...
Image Background Remover detects the main subject and returns a PNG with transparency. Fine hair, transparent objects, and low-contrast edges may need cleanup.
...
The API returns a **PNG with a transparent background**. The file:
