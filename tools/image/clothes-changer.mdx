...
3. Set the garment type to `upper_body`, `lower_body`, or `entire_outfit`.
...
- `entire_outfit` covers dresses, jumpsuits, and full outfits. This is the default.

`dresses` is deprecated; use `entire_outfit` instead.
...
result = client.v1.ai_clothes_changer.generate(
    assets={
        "person_file_path": "https://raw.githubusercontent.com/runshouse/Sample_Assets/main/rookiesteph.jpg",
        "garment_file_path": "https://raw.githubusercontent.com/runshouse/Sample_Assets/main/bullsjersey.webp",
        "garment_type": "upper_body"
    },
    name="Clothes Changer image",
    wait_for_completion=True,
...
Clothes Changer has no API parameter for output resolution. Check the
[current endpoint](/api-reference/image-projects/ai-clothes-changer) and [plan details](/billing/resolution-limits)
when planning output sizes.
