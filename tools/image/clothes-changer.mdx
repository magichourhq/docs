...
const result = await client.v1.aiClothesChanger.generate({
  assets: {
    personFilePath: "https://raw.githubusercontent.com/runshouse/Sample_Assets/main/rookiesteph.jpg",
    garmentFilePath: "https://raw.githubusercontent.com/runshouse/Sample_Assets/main/bullsjersey.webp",
...
const result = await client.v1.aiClothesChanger.generate({
  assets: {
    personFilePath: "https://raw.githubusercontent.com/runshouse/Sample_Assets/main/bullsjersey.webp",
    garmentFilePath: "https://raw.githubusercontent.com/runshouse/Sample_Assets/main/rookiesteph.jpg",
    garmentType: "upper_body"
  },
  name: "Clothes Changer image",
  waitForCompletion: true,
