...
description: Replace a detected face in a photo with a face from another image.
---
...
Face Swap Photo replaces a detected face in a target image with a face from a source image. The model attempts to match the target expression and lighting. Large differences in angle, lighting, or image quality can reduce output quality.
...
<CardGroup cols={2}>
  ...
  <Card title="Face Swap Video" icon="video" href="/tools/video/face-swap-video">
    Replace a detected face across video frames
  </Card>
