...
Headshot Generator has no API parameter for output resolution. Check the
[current endpoint](/api-reference/image-projects/ai-headshot-generator) and [plan details](/billing/resolution-limits)
