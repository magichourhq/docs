...
AI Image Upscaler enlarges an image by 2x or 4x. Its enhancement modes may sharpen or generate
replacement detail, but they cannot recover the source image's original missing information.
...
- **Check for existing blur** - Enhancement may generate replacement detail, not recover the original detail
