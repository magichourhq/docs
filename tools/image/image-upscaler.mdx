...
3. The API enlarges the image using the selected enhancement mode.
...
<Tip>
  **Start with the best source available** - Compression, blur, and other defects can remain visible
  or become more pronounced after upscaling.
</Tip>
