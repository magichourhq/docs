...
<Tip>
  Similar head orientation, camera distance, and light direction
  produce more natural blends.
</Tip>
...
Output is capped by your plan and at most 2048px on its larger dimension. Values of `max_resolution` above your plan maximum are clamped to that maximum.
