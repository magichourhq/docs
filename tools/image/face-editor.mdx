...
2. Set numeric `style` controls for the expression, gaze, or head pose.
...
Numeric controls accept values from -100 to 100 in increments of 5; 0 leaves a control neutral. `enhance_face` is a separate boolean option.
...
<Card
  ...
  icon="webhook"
  href="/api-reference/image-projects/ai-face-editor"
>
