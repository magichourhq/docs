...
description: Generate speech from a reference recording of a voice you have permission to use.
---
...
AI Voice Cloner generates speech from text and a reference recording. Similarity depends on the recording, spoken text, language, and voice characteristics.

<Warning>Use only recordings you own or have permission to use.</Warning>
...
- **Authorized voice preservation** - Reuse a consenting speaker's voice for future recordings
- **Multilingual speech** - Generate speech in Chinese, English, Japanese, Korean, German, French, Russian, Portuguese, Spanish, or Italian
...
- **Be at least 3 seconds long** - About 10 seconds of clean, single-speaker speech is a stronger starting point
...
<Tip>
  **Record naturally** - Speak in your usual tone and pace so the sample reflects how you sound.
</Tip>
...
- **Short clips** - Use 1-2 sentences for short-form content
