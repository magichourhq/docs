...
Try the [Voice Cloner web tool](https://magichour.ai/products/ai-voice-cloner), or use the API examples below. The web tool has language controls. The published API accepts a sample and text without a language parameter.
