...
description: Create stylized, morphing animation from a prompt with optional image or audio.
---

import { ToolSection } from "/snippets/tool-section.mdx";

Create stylized, morphing visuals from a prompt, with an optional starting image or audio track. To animate a still scene with natural motion, use [Image to Video](/tools/video/image-to-video). To make a portrait speak, use [Talking Photo](/tools/video/talking-photo).
...
<CardGroup cols={2}>
  ...
  <Card title="Text to Video" icon="align-left" href="/tools/video/text-to-video">
