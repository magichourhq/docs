...
Provide a photo of the face you want to use and a target video. Start with a short clip where the target face is clearly visible.
...
<CardGroup cols={2}>
  ...
  <Card title="Lip Sync" icon="microphone" href="/tools/video/lip-sync">
