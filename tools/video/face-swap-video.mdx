...
description: Replace a detected face across frames in a video segment.
---
...
Face Swap Video replaces a detected face across frames in a selected video segment. Fast motion, occlusion, lighting changes, and large angle differences can reduce consistency.
...
4. **API processes frame-by-frame** - AI tracks and replaces the detected face across frames
