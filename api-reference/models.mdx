...
| `sora-2`            | 720p output; maximum duration: 60 seconds      | 720p              | 4, 8, 12, 24, 36, 48, 60                                                                             | Yes, no extra credits |

<Note>
  `default` resolves to `kling-3.0` on paid tiers and `ltx-2.3` on the free tier. Free typically
