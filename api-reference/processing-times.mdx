...
7 through September 5, 2026**. Five values use the latest 48-hour cohort, from **September 5 at
17:00 through September 7 at 17:00 UTC**, and are marked with §. Four unchanged values use the prior
48-hour cohort, from **September 4 at 01:00 through September 6 at 01:00 UTC**, and are marked with
‡. All values measure end-to-end time from project creation to completion, including queueing. The
warehouse snapshot was queried on September 7, 2026.
...
§ Uses the latest 48-hour API cohort, from September 5 at 17:00 through September 7 at 17:00 UTC,
because its median was faster than the currently published value. Other rows retain their published
baseline or prior 48-hour value.
