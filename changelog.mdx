...
<Frame>![New Lip Sync UI](/changelog/images/2025/09/new-lip-sync-ui.jpg)</Frame>
...
## Added `Pro` mode to Talking Photo API

We added our new pro mode to the Talking Photo API. You can now use the `Pro` mode to generate talking photos with higher quality and more natural results. You can check out the difference in the [2025-08-31](/changelog#2025-08-31) changelog.

## Added support to export AI Gifs as webm

Now you can export AI Gifs as webm/mp4 files. Just pass in `webm` or `mp4` as the `output_format` param when calling the API. For example:
