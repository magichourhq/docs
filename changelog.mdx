...
<Frame>
  <video
    ...
    playsInline
    className="w-full aspect-video"
    src="https://videos.magichour.ai/api-assets/docs/lip-sync-james-bond.webm"
  ></video>
</Frame>
...
<Frame>
  <video
    ...
    playsInline
    className="w-full aspect-video"
    src="https://videos.magichour.ai/api-assets/docs/v2v-quality-improvement.mp4"
  ></video>
</Frame>
...
<Frame>
  <video
    ...
    playsInline
    className="w-full aspect-video"
    src="https://videos.magichour.ai/api-assets/docs/i2v-island-video-cool.mp4"
  ></video>
</Frame>
...
<Frame>
  <video
    ...
    playsInline
    className="w-full aspect-video"
    src="https://videos.magichour.ai/api-assets/docs/final-faceswap-before-after.webm"
  ></video>
</Frame>
