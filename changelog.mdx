...
To take advantage of the this change, please upgrade your sdk version to `v0.31.0`.

- [Python SDK v0.31.0](https://github.com/magichourhq/magic-hour-python/releases/tag/v0.31.0)
- [Node SDK v0.31.0](https://github.com/magichourhq/magic-hour-node/releases/tag/v0.31.0)
- [Go SDK v0.31.0](https://github.com/magichourhq/magic-hour-go/releases/tag/v0.31.0)
- [Rust SDK v0.31.0](https://github.com/magichourhq/magic-hour-rust/releases/tag/v0.31.0)
