...
To take advantage of the this change, please upgrade your sdk version to `v0.31.1`.

- [Python SDK v0.31.1](https://github.com/magichourhq/magic-hour-python/releases/tag/v0.31.1)
- [Node SDK v0.31.1](https://github.com/magichourhq/magic-hour-node/releases/tag/v0.31.1)
- [Go SDK v0.31.1](https://github.com/magichourhq/magic-hour-go/releases/tag/v0.31.1)
- [Rust SDK v0.31.1](https://github.com/magichourhq/magic-hour-rust/releases/tag/v0.31.1)
