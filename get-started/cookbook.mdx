...
<Card title="Product Video and Lip-Sync Recipes" icon="code" href="/get-started/starter-recipes">
  Run two focused Python workflows with your own local files, from upload to downloaded video.
</Card>
