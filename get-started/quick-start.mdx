...
See the result of your generation at the [My Images Page](https://magichour.ai/dashboard/images) or checkout the [full integration guide](/integration/adding-api-to-your-app) to see how to download the output.
...
See the result of your generation at the [My Videos Page](https://magichour.ai/dashboard/videos) or checkout the [full integration guide](/integration/adding-api-to-your-app) to see how to download the output.
