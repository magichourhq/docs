...
- `download_directory: "outputs"` - Save into the `outputs` directory you created above
...
If you encounter HTTP errors, here's what they mean. For the full list of HTTP statuses **and** application error codes (with causes and fixes), see the [Errors reference](/get-started/errors).
