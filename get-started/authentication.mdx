...
![Sign in page](./images/sign-in-to-magic-hour.png)
</Step>
...
![Developer Hub with API Keys](./images/navigate-to-developer-hub.png)
</Step>

<Step title="Create New API Key">
Click the **"Create API Key"** button to generate a new key.

![Create API Key button](./images/create-new-api-key.png)
</Step>
...
![API Key configuration](./images/configure-your-api-key.png)
...
![API Key created](./images/copy-and-store-api-key.png)
...
![API Keys list](./images/copy-and-store-api-key.png)
...
![Revoke API Key](./images/revoking-api-keys.png)
...
**Solutions**:
- Verify your account has the necessary permissions for the requested operation
- Verify your account has the necessary permissions
- Ensure your subscription supports the requested operation

### `429 Too Many Requests`
**Cause**: Rate limit exceeded
**Solutions**:
- Implement exponential backoff in your retry logic
- Check your rate limits in the Developer Hub
...
- **Last Activity**: When each key was last used

This helps you:
- Identify which applications are using which keys
