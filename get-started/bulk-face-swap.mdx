...
2. Download the matching companion worker from this guide's [versioned source](https://github.com/magichourhq/docs/tree/codex/bulk-face-swap-docs/examples/bulk-face-swap):
