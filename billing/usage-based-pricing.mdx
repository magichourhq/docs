...
Open **Analytics & Billing** in the
[Developer Hub](https://magichour.ai/developer?ref=docs-usage-based-pricing) to view usage for a
specific time range, your upcoming invoice, and credit usage broken down by tier.
