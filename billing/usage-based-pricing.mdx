...
Start without prepaid credits after usage-based billing is configured.
...
<Note>
  Confirm the rates, billing-period boundary, and invoice schedule for your account during setup.
</Note>
...
2. Confirm your tier and rates with the team based on expected volume and required features.
...
- Monthly billing follows the schedule confirmed during setup.
- High usage accounts may have an earlier billing threshold. Confirm it with the team.
