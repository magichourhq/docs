...
Creator, Pro, and Business also differ on credits per month and support.
...
For API requests, use the endpoint schema and selected model to determine which resolution
parameter and limits apply.
