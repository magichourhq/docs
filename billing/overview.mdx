...
The [pricing page](https://magichour.ai/pricing) lists purchased credits as non-expiring.
Promotional credits can have separate terms; check your account and the applicable offer.
...
| **Volume discounts** | Annual plan discount              | Listed pack price                  | Graduated monthly usage discounts   |
...
Choose a plan when you want a predictable budget, recurring credits, and priority support.
...
Prices are in USD. Annual plans are billed as $144 / $300 / $792 per year; checkout may show
local currency and applicable taxes. Paid plans remove watermarks, include
...
not unlock models, resolutions, or other features reserved for a paid plan. Purchase
