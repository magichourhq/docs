...
Credit packs do not include subscription benefits other than removing watermarks. Purchase them on
the [pricing page](https://magichour.ai/pricing?ref=docs-billing-overview#credit-pack).
