...
When you're ready to ramp up your API usage, you have two subscription options to choose from. There are pros and cons of each option depending on your own use cases.
...
Usage-based pricing includes volume discounts, so each frame becomes cheaper as you scale.

<Card
  title="Usage-Based Pricing Details"
  icon="chart-simple"
  href="/billing/usage-based-pricing2"
  horizontal
>
